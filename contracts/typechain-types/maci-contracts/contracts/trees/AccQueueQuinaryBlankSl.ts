...
export interface AccQueueQuinaryBlankSlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueueQuinaryBlankSl extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueueQuinaryBlankSl;
  waitForDeployment(): Promise<this>;

  interface: AccQueueQuinaryBlankSlInterface;
