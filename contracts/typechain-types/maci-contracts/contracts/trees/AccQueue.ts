...
export interface AccQueueInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_DEPTH"
      | "calcMinHeight"
...
export interface AccQueue extends BaseContract {
  connect(runner?: ContractRunner | null): AccQueue;
  waitForDeployment(): Promise<this>;

  interface: AccQueueInterface;
