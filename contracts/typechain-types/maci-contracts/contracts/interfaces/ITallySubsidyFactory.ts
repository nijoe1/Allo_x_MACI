...
export interface ITallySubsidyFactoryInterface extends Interface {
...
export interface ITallySubsidyFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ITallySubsidyFactory;
  waitForDeployment(): Promise<this>;

  interface: ITallySubsidyFactoryInterface;
