...
export interface QVMACIBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NATIVE"
      | "TREE_ARITY"
...
export interface QVMACIBase extends BaseContract {
  connect(runner?: ContractRunner | null): QVMACIBase;
  waitForDeployment(): Promise<this>;

  interface: QVMACIBaseInterface;
