...
export interface ClonableAccQueueQuinaryBlankSlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "HASH_LENGTH"
      | "MAX_DEPTH"
...
export interface ClonableAccQueueQuinaryBlankSl extends BaseContract {
  connect(runner?: ContractRunner | null): ClonableAccQueueQuinaryBlankSl;
  waitForDeployment(): Promise<this>;

  interface: ClonableAccQueueQuinaryBlankSlInterface;
  ...
  ): TypedContractMethod<[_subDepth: BigNumberish], [void], "nonpayable">;
  getFunction(
