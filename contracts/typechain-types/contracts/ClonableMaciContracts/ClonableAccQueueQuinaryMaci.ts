...
export interface ClonableAccQueueQuinaryMaciInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "HASH_LENGTH"
      | "MAX_DEPTH"
...
export interface ClonableAccQueueQuinaryMaci extends BaseContract {
  connect(runner?: ContractRunner | null): ClonableAccQueueQuinaryMaci;
  waitForDeployment(): Promise<this>;

  interface: ClonableAccQueueQuinaryMaciInterface;
