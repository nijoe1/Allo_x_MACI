...
export interface ClonablePollInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MESSAGE_DATA_LENGTH"
      | "coordinatorPubKey"
...
export interface ClonablePoll extends BaseContract {
  connect(runner?: ContractRunner | null): ClonablePoll;
  waitForDeployment(): Promise<this>;

  interface: ClonablePollInterface;
