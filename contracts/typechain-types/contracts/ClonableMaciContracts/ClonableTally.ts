...
export interface ClonableTallyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ClonableTally extends BaseContract {
  connect(runner?: ContractRunner | null): ClonableTally;
  waitForDeployment(): Promise<this>;

  interface: ClonableTallyInterface;
