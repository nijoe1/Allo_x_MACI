...
import { MerkleZeros as MerkleQuinaryBlankSl } from "maci-contracts/contracts/trees/zeros/MerkleQuinaryBlankSl.sol";
import { OwnableUpgradeable } from "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import { Hasher } from "maci-contracts/contracts/crypto/Hasher.sol";

/// @title ClonableAccQueueQuinaryBlankSl
...
contract ClonableAccQueueQuinaryBlankSl is Hasher, OwnableUpgradeable, MerkleQuinaryBlankSl {
    uint256 public constant HASH_LENGTH = 5;

    function initialize(uint256 _subDepth) public initializer {
        __Context_init_unchained();
        __Ownable_init_unchained();

        uint256 _hashLength = HASH_LENGTH;
    ...
    uint256 internal hashLength;

    // hashLength ** subDepth
    uint256 internal subTreeCapacity;
